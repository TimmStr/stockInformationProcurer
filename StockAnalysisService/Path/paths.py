...
STOCK_WEB_SCRAPING_SERVICE_GET_STOCK_FROM_TICKER = STOCK_WEB_SCRAPING_SERVICE + "getStockFromTicker"
STOCK_WEB_SCRAPING_SERVICE_SAVE_STOCK = STOCK_WEB_SCRAPING_SERVICE + "saveStock"
STOCK_WEB_SCRAPING_SERVICE_GET_ALL_STOCKS = STOCK_WEB_SCRAPING_SERVICE + "getAllStocks"
STOCK_WEB_SCRAPING_SERVICE_DELETE_ALL_STOCKS = STOCK_WEB_SCRAPING_SERVICE + "deleteAllStocks"
STOCK_WEB_SCRAPING_SERVICE_GET_KPIS_FROM_TICKER = STOCK_WEB_SCRAPING_SERVICE + "getKpisFromTicker"
